test_that("addStatistics GiottoDB vs Giotto equivalence", {
  ...
  expect_equal(
    g_stats$feat_stats$total_expr,
    gdb_stats$feat_stats$total_expr,
    tolerance = 1e-10
  )
  expect_equal(
    g_stats$feat_stats$mean_expr_det,
    gdb_stats$feat_stats$mean_expr_det,
    tolerance = 1e-10
  )
  ...
  expect_equal(
    g_stats$cell_stats$total_expr,
    gdb_stats$cell_stats$total_expr,
    tolerance = 1e-10
  )
  ...
  expect_equal(
    g_stats$poly_stats$area,
    gdb_stats$poly_stats$area,
    tolerance = 1e-10
  )
})
