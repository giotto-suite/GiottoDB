...
setMethod("processData",
    ...
    function(x, param, ...) {
        ...
        allMatrix_method <- getMethod("processData", signature("allMatrix", "libraryNormParam"))
...
setMethod("processData",
    ...
    function(x, param, ...) {
        # Get and call the allMatrix method directly
        allMatrix_method <- getMethod("processData", signature("allMatrix", "l2NormParam"))
        allMatrix_method(x, param, ...)
    }
)
...
setMethod("processData",
    ...
    function(x, param, ...) {
        stop("TF-IDF normalization is not currently supported for dbMatrix objects.",
             call. = FALSE)
    }
)
...
setMethod("processData",
    ...
    function(x, param, ...) {
        stop("Quantile normalization is not currently supported for dbMatrix objects.",
             call. = FALSE)
    }
)
...
setMethod("processData",
    ...
    function(x, param, ...) {
        # Get and call the allMatrix method directly
        allMatrix_method <- getMethod("processData", signature("allMatrix", "osmFISHNormParam"))
        allMatrix_method(x, param, ...)
    }
)
...
setMethod("processData",
    ...
    function(x, param, ...) {
        # Get and call the allMatrix method directly
        allMatrix_method <- getMethod("processData", signature("allMatrix", "arcsinhNormParam"))
        allMatrix_method(x, param, ...)
    }
)
...
setMethod("processData",
    ...
    function(x, param, ...) {
        # Get and call the allMatrix method directly
        allMatrix_method <- getMethod("processData", signature("allMatrix", "zscoreScaleParam"))
        allMatrix_method(x, param, ...)
    }
)
